...
def test_network_copy_reordered(dtype, num_charges):
  a = tn.Node(
    get_random_symmetric((30, 30, 30), [False, False, False], num_charges, dtype=dtype),
    backend="symmetric",
  )
  b = tn.Node(
    get_random_symmetric((30, 30, 30), [False, True, False], num_charges, dtype=dtype),
    backend="symmetric",
  )
  c = tn.Node(
    get_random_symmetric((30, 30, 30), [True, False, True], num_charges, dtype=dtype),
    backend="symmetric",
  )
...
def test_real_physics(dtype, num_charges):
  ...
  t2 = get_random_symmetric((20, 20, 20), [True, False, True], num_charges, dtype=dtype)
  t3 = get_random_symmetric((20, 20, 20), [True, True, False], num_charges, dtype=dtype)
...
def test_node2_contract_trace(dtype, num_charges):
  a = tn.Node(
    get_random_symmetric((20, 20, 20), [False, True, False], num_charges, dtype=dtype),
    backend="symmetric",
  )
  b = tn.Node(
...
def test_flatten_consistent_result(dtype, num_charges):
  a_val = get_random_symmetric((10, 10, 10, 10), [False] * 4, num_charges, dtype=dtype)
